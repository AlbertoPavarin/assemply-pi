...
main:	ldr r1, =V 	@ Carico l'indirizzo del vettore
	mov r2, #1 	@ Contatore del for
	ldr r3, =n
	ldr r3, [r3]	@ Contiene il valore della dimensione dell'array
	ldr r0, [r1]	@ Salvo il primo valore
	mov r4, #0	@ Valore dell'indice del valore max

loop:	ldr r5, [r1, r2, lsl #2] @ V + i * 2^2, V[i]
	cmp r0, r5
	movlt r0, r5
	movlt r4, r2
	add r2, r2, #1
